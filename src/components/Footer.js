...
class Footer extends Component {  //creo la classe del footer
    render() {
        return (
            <footer className="footer">  {/* questo è il footer con l'assegnazione delle classi per il css*/} 
                <div className="footer-container"> {/*link attivabili che portano a google*/}
